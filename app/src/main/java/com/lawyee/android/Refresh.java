...
import com.lawyee.apppublic.ui.InfomDetailsActivity;
import com.lawyee.apppublic.vo.InfomationVO;
import com.lawyee.apppublic.vo.VideoInfomationVO;
...
public class Refresh extends Fragment {
    private static  final String TAG = Infom_CaseFragment.class.getSimpleName();
    ...
    private void initView(View view) {
        mRlvInformItem = (RecyclerView) view.findViewById(R.id.rlv_infrom_item);
     ...
     /*   mXrefreshview.enableReleaseToLoadMore(true);
        ...
        mXrefreshview.setEmptyView(view.findViewById(R.id.casefragment_empty_tv));
    }
    ...
    private void setAdapetData() {
        ...
        mDataAdapter.setOnRecyclerViewClickListener(new InformRecyclerViewAdapter.OnRecyclerViewClickListener() {
            ...
            public void onItemClickListener(View view, int position) {
                ...
                if(ivo instanceof VideoInfomationVO)
                {
                    //TODO 视频资讯处理方式
                    BaseActivity.runBrowser(((VideoInfomationVO) ivo).getVideoUrl(),getActivity());
                    return;
                }
    ...
    private void loadData()
    {
        clearDataList();
        //读取缓存
        List list = InfomationVO.loadVOList(InfomationVO.dataListFileName(getActivity(),getTypeID()));
    ...
    protected void loadNewData()
    {
        ...
        service.getList(isVideoType(),getTypeID(), 1, mOrgId, new BaseJsonService.IResultInfoListener() {
            ...
            public void onComplete(ArrayList<Object> values, String content) {
                ...
                //缓存数据
                InfomationVO.saveVOList(mDataList,InfomationVO.dataListFileName(getActivity(),getTypeID()));
